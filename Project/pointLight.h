...
public:
    ...
    void setUpPointLight(Shader& lightingShader)
    {
        ...
        if (lightNumber == 1) {
            ...
            lightingShader.setVec3("pointLights[0].emission", glm::vec3(1.0f, 0.0f, 0.0f));
        ...
        else if (lightNumber == 7)
        {
            ...
            lightingShader.setVec3("pointLights[6].emission", glm::vec3(0.2f, 0.2f, 0.2f));
        ...
        else if (lightNumber == 8)
        {
            ...
            lightingShader.setVec3("pointLights[7].emission", glm::vec3(0.2f, 0.2f, 0.2f));
        ...
        else if (lightNumber == 9)
        {
            ...
            lightingShader.setVec3("pointLights[8].emission", glm::vec3(0.2f, 0.2f, 0.2f));
        ...
        else if (lightNumber == 10)
        {
            ...
            lightingShader.setVec3("pointLights[9].emission", glm::vec3(0.2f, 0.2f, 0.2f));
